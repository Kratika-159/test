...
def voice_to_text():
    r=sr.Recognizer()
    with sr.AudioFile('D:/Major/Smart-Speech-Analysis/recorded/output1.wav') as source:
...
def Play_sound():
    filename = 'D:/Major/Smart-Speech-Analysis/recorded/output1.wav'
    #playsound(filename)
...
def Voice_rec():
    os.remove(r"D:\Major\Smart-Speech-Analysis\recorded\cleaned.wav")
    os.remove(r"D:\Major\Smart-Speech-Analysis\recorded\output1.wav")
    CHUNK = 1024 
    ...
    WAVE_OUTPUT_FILENAME = "D:/Major/Smart-Speech-Analysis/recorded/output1.wav"
    ...
    wf.close()
    file = 'D:/Major/Smart-Speech-Analysis/recorded/output1.wav'
    signal , rate = librosa.load(file, sr=16000)
    mask = envelope(signal,rate, 0.0005)
    wavfile.write(filename= r'D:\Major\Smart-Speech-Analysis\recorded\cleaned.wav', rate=rate,data=signal[mask])
    voice_to_text()

def Make_prediction():
    file1 = 'D:/Major/Smart-Speech-Analysis/recorded/cleaned.wav'
    ans =[]
    new_feature = extract_feature(file1, mfcc=True, chroma=True, mel=True)
    ans.append(new_feature)
    ans = np.array(ans)
    Pkl_Filename = "D:/Major/Smart-Speech-Analysis/SER_by_NOR.pkl"
...
img = ImageTk.PhotoImage(Image.open("D:/Major/Smart-Speech-Analysis/record.png").resize((500, 500)))
